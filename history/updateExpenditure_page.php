<html>
    ...
    <body>
        ...
        <h3>Search for the expenditure or expenditures to update</h3>
        <p>
        <u>NOTE!</u><br>
        1. Empty fields will not be used<br>
        2. expenditureID is unique to each row<br>
        3. date must be in the form yyyy-mm-dd <br>
        4. out_in must be either (+,-) <br>
        </p>
        <br><br>
        <form action="search_updateExpenditure.php" method="post">
            ...
            <input type="submit" action="search_updateExpenditure.php" value="search">
        </form>
    </body>
</html>
