<html>
    ...
    <body>
        ...
        <h3>Search for the punch or punchs to update</h3>
        <p>
        <u>NOTE!</u><br>
        1. Empty fields will not be used<br>
        </p>
        <br><br>
        <form action="search_updatePunch.php" method="post">
            ...
            <input type="submit" action="search_updatePunch.php" value="search">
        </form>
    </body>
</html>
