...
function titleChanger(){
    ...
    year = text.slice(-4);
    document.getElementById("title").innerHTML = "<h1>Expenditure Report By " + view + " " +  year + "</h1>";
}

</script>
<br><br><br>
<div class='title' id='title'>
<h1>Expenditure Report By Category 2018</h1>
</div>
...
for($i = $date; $i >= $date - 5; $i--){
    ...
    showExpenditureReportByCategory($db,$i);
    echo "</div>";
    echo "<div id='$view2$i' hidden>";
    showExpenditureReportByAccount($db,$i);
    echo "</div>";
}

//default expenditure shown for this year
