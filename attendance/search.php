    ...
    <body>
        ...
        <hr>
            <div class="menu">
                ...
                <span ><a class="button" href="all.php">All Rooms</a></span>
        ...
        ?>
            ...
            <input class='rectpretty' style='height:50px;' type='submit' name='type' value='sign in'>
            <input class='rectpretty' style='height:50px;' type='submit' name='type' value='sign out'>
        </form>
