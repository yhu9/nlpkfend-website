...
<h1>Emergency_Contact Table</h1>
    ...
    <?php
        ...
        if($result !== false){
            ...
            //row1,row2,row3,row4,...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            echo "<form action=\"execute_deleteEmergency_Contact.php\" method=\"POST\">\n";
            if($result !== false){
            ...
            echo "<input type=\"submit\" action=\"execute_deleteEmergency_Contact.php\" value=\"Delete This Now!\">\n";
            echo "</form>\n";
