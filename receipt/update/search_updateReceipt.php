...
<h1>Search Result</h1>
    ...
    <?php
        ...
        if($result !== false){
            ...
            //row1,row2,row3,row4,...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            echo "<form action=\"execute_updateReceipt.php\" method=\"POST\">\n";
            if($result !== false){
        ...
        foreach($finfo as $field){
            ...
            if($field->name == "receiptID"){
                ...
                echo "<td align='center'>\n";
                echo "<input type='text' size='2' maxlength='2' placeholder='HH' name=\"$field->name[year]\">\n";
                echo ":";
                echo "<input type='text' size='2' maxlength='2' placeholder='MM' name=\"$field->name[month]\">\n";
                echo ":";
                echo "<input type='text' size='2' maxlength='2' placeholder='SS' name=\"$field->name[day]\">\n";
                echo "</td>";
        ...
        echo "</table>";
        echo "<input type=\"submit\" action=\"execute_updateReceipt.php\" value=\"UPDATE NOW\">\n";
        echo "</form>";
