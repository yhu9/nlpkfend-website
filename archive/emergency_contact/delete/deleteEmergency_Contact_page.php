<html>
    ...
    <body>
        ...
        <form action="search_deleteEmergency_Contact.php" method="post">
            <h3>Search for the emergency_contact or emergency_contacts to delete</h3>
            <u>NOTE!</u><br>
            1. Empty fields will not be used<br>
            2. date must be in form yyyy-mm-dd <br>
            <br><br>
                    ...
                    if($result !== false){
                        ...
                        foreach($finfo as $field){
                            ...
                            if($field->name == "phone_number" or $field->name == "cellphone"){
                                ...
                                echo "<td align=\"center\"><input type=\"text\" name=\"text_$field->name\" placeholder='first name of child'></td>";
                            }elseif($field->name == "last_name"){
                                echo "<td align=\"center\"><input type=\"text\" name=\"text_$field->name\" placeholder='last name of child'></td>";
            ...
            <input type="submit" action="search_deleteEmergency_Contact.php" value="Search for emergency_contacts to delete">
        </form>
    </body>
</html>
