<html>
    ...
    <body>
        ...
        <form action="executeAddEmergency_Contact.php" method="post">
            <h3>Fill Out Your Emergency_Contact to Add</h3>
            <p>
            <u>NOTE!</u><br>
                ...
                <?php
                    ...
                    if($result !== false){
                        ...
                        foreach($finfo as $field){
                            ...
                            if($field->name == "emergency_contactID" or $field->name == "date" or $field->name == "time"){
            ...
            <input type="submit" action="executeAddEmergency_Contact.php" value="Add Emergency_Contact Now">
        </form>
    </body>
</html>
