<html>
    ...
    <body>
        ...
        <h3>Search for the payroll or payrolls to update</h3>
        <br><br>
        <form action="search_updatePayroll.php" method="post">
            ...
            <input type="submit" action="search_updatePayroll.php" value="search">
        </form>
    </body>
</html>
